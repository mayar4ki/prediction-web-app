...
export type _UseBetIndexOptions = UseReadContractParameters<typeof aiPredictionV1.abi, 'getAllRounds'>;

type NoRefUseBetIndexOptions = UnwrapRef<_UseBetIndexOptions>

export type UseBetIndexOptions = Omit<NoRefUseBetIndexOptions, 'address' | 'abi' | 'functionName'>;
